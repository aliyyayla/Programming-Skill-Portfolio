...
make_shirt("Medium","MOA FOREVER") #call my function using positional arguments
make_shirt(size = "Medium", text = "MOA FOREVER") #call my function using keyword arguments
