...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 13 15:53:32 2023
...
def favorite_book(title):
    print("My favorite book i'm currently reading is", title)
    
favorite_book("Marriage For Once.") #call my function using the title as an argument in the function call